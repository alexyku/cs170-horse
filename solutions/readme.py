...
The solution maker is a single thread program, so it will use at most one core of your CPU. Macbook pros have 4 cores. So if you run multiple instances of the program at the same time, you actually increase the number of solutions you produce.
